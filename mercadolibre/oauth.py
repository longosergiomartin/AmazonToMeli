...
class TokenStore:
    ...
    def __init__(self, conn):
        self.conn = conn
        # Va por `preparar` para que el esquema se aplique al abrir la conexión
        # —no al arrancar la app— y se reaplique solo si hay que reconectar
        # (base dormida en la nube).
        self.conn.preparar("""
